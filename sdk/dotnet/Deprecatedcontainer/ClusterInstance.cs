...
{
    [TencentcloudResourceType("tencentcloud:Deprecatedcontainer/clusterInstance:ClusterInstance")]
    public partial class ClusterInstance : global::Pulumi.CustomResource
    {
        ...
        public ClusterInstance(string name, ClusterInstanceArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedcontainer/clusterInstance:ClusterInstance", name, args ?? new ClusterInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterInstance(string name, Input<string> id, ClusterInstanceState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedcontainer/clusterInstance:ClusterInstance", name, state, MakeResourceOptions(options, id))
        {
        }
