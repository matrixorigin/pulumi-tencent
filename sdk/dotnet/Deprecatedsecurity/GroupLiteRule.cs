...
{
    [TencentcloudResourceType("tencentcloud:Deprecatedsecurity/groupLiteRule:GroupLiteRule")]
    public partial class GroupLiteRule : global::Pulumi.CustomResource
    {
        ...
        public GroupLiteRule(string name, GroupLiteRuleArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedsecurity/groupLiteRule:GroupLiteRule", name, args ?? new GroupLiteRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupLiteRule(string name, Input<string> id, GroupLiteRuleState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedsecurity/groupLiteRule:GroupLiteRule", name, state, MakeResourceOptions(options, id))
        {
        }
