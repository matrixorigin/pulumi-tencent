...
{
    [TencentcloudResourceType("tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress")]
    public partial class Ipv6EniAddress : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Ipv6EniAddress(string name, Ipv6EniAddressArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress", name, args ?? new Ipv6EniAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ipv6EniAddress(string name, Input<string> id, Ipv6EniAddressState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class Ipv6EniAddressArgs : global::Pulumi.ResourceArgs
    {
        [Input("ipv6Addresses")]
        ...
        public static new Ipv6EniAddressArgs Empty => new Ipv6EniAddressArgs();
    }

    public sealed class Ipv6EniAddressState : global::Pulumi.ResourceArgs
    {
        [Input("ipv6Addresses")]
        ...
        public static new Ipv6EniAddressState Empty => new Ipv6EniAddressState();
    }
}
