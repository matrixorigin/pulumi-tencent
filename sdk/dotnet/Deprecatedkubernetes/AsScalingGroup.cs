...
namespace Pulumi.Tencentcloud.Deprecatedkubernetes
{
    [TencentcloudResourceType("tencentcloud:Deprecatedkubernetes/asScalingGroup:AsScalingGroup")]
    public partial class AsScalingGroup : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AsScalingGroup(string name, AsScalingGroupArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedkubernetes/asScalingGroup:AsScalingGroup", name, args ?? new AsScalingGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AsScalingGroup(string name, Input<string> id, AsScalingGroupState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedkubernetes/asScalingGroup:AsScalingGroup", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class AsScalingGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Auto scaling config parameters.
        /// </summary>
        ...
        public static new AsScalingGroupArgs Empty => new AsScalingGroupArgs();
    }

    public sealed class AsScalingGroupState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Auto scaling config parameters.
        /// </summary>
        ...
        public static new AsScalingGroupState Empty => new AsScalingGroupState();
    }
}
