...
class RocketmqTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] topic_type: Topic type. `UNSPECIFIED`: not specified, `NORMAL`: normal message, `FIFO`: sequential message, `DELAY`: delayed
               message.
...
class RocketmqTopic(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RocketmqTopic resource with the given unique name, props, and options.
