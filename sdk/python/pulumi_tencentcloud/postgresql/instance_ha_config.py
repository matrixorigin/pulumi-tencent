...
class InstanceHaConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_standby_lag: Maximum latency of highly available backup machines. When the delay time of the backup node is less than or equal to
        ...
        :param pulumi.Input[int] max_standby_latency: Maximum latency data volume for highly available backup machines. When the delay data amount of the backup node is less
        ...
        :param pulumi.Input[str] sync_mode: Master slave synchronization method, Semi-sync: Semi synchronous; Async: Asynchronous. Main instance default value:
               Semi-sync, Read-only instance default value: Async.
        :param pulumi.Input[int] max_sync_standby_lag: Maximum delay time for synchronous backup. When the delay time of the standby machine is less than or equal to this
        ...
        :param pulumi.Input[int] max_sync_standby_latency: Maximum latency data for synchronous backup. When the amount of data delayed by the backup machine is less than or equal
...
class InstanceHaConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstanceHaConfig resource with the given unique name, props, and options.
