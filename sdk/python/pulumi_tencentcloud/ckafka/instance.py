...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] instance_type: Description of instance type. `profession`: 1, `standard`: 1(general), 2(standard), 3(advanced), 4(capacity),
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceTagArgs']]] tags: Tags of instance. Partition size, the professional version does not need tag.
        :param pulumi.Input[int] upgrade_strategy: POSTPAID_BY_HOUR scale-down mode - 1: stable transformation; - 2: High-speed transformer.
    ...
    def upgrade_strategy(self) -> Optional[pulumi.Input[int]]:
        """
        POSTPAID_BY_HOUR scale-down mode - 1: stable transformation; - 2: High-speed transformer.
        """
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] subnet_id: Subnet id, it will be basic network if not set.
        :param pulumi.Input[Mapping[str, Any]] tag_set: Tag set of instance.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceTagArgs']]]] tags: Tags of instance. Partition size, the professional version does not need tag.
        :param pulumi.Input[int] upgrade_strategy: POSTPAID_BY_HOUR scale-down mode - 1: stable transformation; - 2: High-speed transformer.
        :param pulumi.Input[str] vpc_id: Vpc id, it will be basic network if not set.
        :param pulumi.Input[int] zone_id: Available zone id.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] zone_ids: List of available zone id. NOTE: this argument must set together with `multi_zone_flag`.
