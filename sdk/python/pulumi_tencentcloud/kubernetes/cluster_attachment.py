...
class ClusterAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] unschedulable: Sets whether the joining node participates in the schedule. Default is `0`, which means it participates in scheduling.
