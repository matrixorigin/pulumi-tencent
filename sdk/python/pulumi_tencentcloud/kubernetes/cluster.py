...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_internet_domain: Domain name for cluster Kube-apiserver internet access. Be careful if you modify value of this parameter, the
        ...
        :param pulumi.Input[bool] cluster_intranet: Open intranet access or not. If this field is set 'true', the field below `worker_config` must be set. Because only
               cluster with node is allowed enable access endpoint. You may open it through `tencentcloud_kubernetes_cluster_endpoint`.
        :param pulumi.Input[str] cluster_intranet_domain: Domain name for cluster Kube-apiserver intranet access. Be careful if you modify value of this parameter, the
        ...
        :param pulumi.Input[str] cluster_os: Cluster operating system, supports setting public images (the field passes the corresponding image Name) and custom
               images (the field passes the corresponding image ID). For details, please refer to:
               https://cloud.tencent.com/document/product/457/68289.
        ...
        :param pulumi.Input[str] cluster_version: Version of the cluster. Use `tencentcloud_kubernetes_available_cluster_versions` to get the upgradable cluster version.
        :param pulumi.Input[str] container_runtime: Runtime type of the cluster, the available values include: 'docker' and 'containerd'.The Kubernetes v1.24 has removed
        ...
        :param pulumi.Input[str] instance_delete_mode: The strategy for deleting cluster instances: terminate (destroy instances, only support pay as you go cloud host
               instances) retain (remove only, keep instances), Default is terminate.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterResourceDeleteOptionArgs']]] resource_delete_options: The resource deletion policy when the cluster is deleted. Currently, CBS is supported (CBS is retained by default). Only
               valid when deleting cluster.
        ...
        :param pulumi.Input[str] vpc_cni_type: Distinguish between shared network card multi-IP mode and independent network card mode. Fill in `tke-route-eni` for
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterWorkerConfigArgs']]] worker_configs: Deploy the machine configuration information of the 'WORKER' service, and create <=20 units for common users. The other
               'WORK' service are added by 'tencentcloud_kubernetes_scale_worker'.
        """
    ...
    def cluster_os(self) -> Optional[pulumi.Input[str]]:
        """
        Cluster operating system, supports setting public images (the field passes the corresponding image Name) and custom
        images (the field passes the corresponding image ID). For details, please refer to:
        https://cloud.tencent.com/document/product/457/68289.
        """
    ...
    def instance_delete_mode(self) -> Optional[pulumi.Input[str]]:
        """
        The strategy for deleting cluster instances: terminate (destroy instances, only support pay as you go cloud host
        instances) retain (remove only, keep instances), Default is terminate.
        """
    ...
    def resource_delete_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterResourceDeleteOptionArgs']]]]:
        """
        The resource deletion policy when the cluster is deleted. Currently, CBS is supported (CBS is retained by default). Only
        valid when deleting cluster.
        """
...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] pre_start_user_script: Base64-encoded user script, executed before initializing the node, currently only effective for adding existing nodes.
        :param pulumi.Input[int] project_id: Project ID, default value is 0.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterResourceDeleteOptionArgs']]]] resource_delete_options: The resource deletion policy when the cluster is deleted. Currently, CBS is supported (CBS is retained by default). Only
               valid when deleting cluster.
        :param pulumi.Input[str] runtime_version: Container Runtime version.
        :param pulumi.Input[str] service_cidr: A network address block of the service. Different from vpc cidr and cidr of other clusters within this vpc. Must be in
               10./192.168/172.[16-31] segments.
