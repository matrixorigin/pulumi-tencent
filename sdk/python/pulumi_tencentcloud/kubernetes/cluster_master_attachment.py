...
class ClusterMasterAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] node_role: Node role, values: MASTER_ETCD, WORKER. MASTER_ETCD needs to be specified only when creating an INDEPENDENT_CLUSTER
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] desired_pod_numbers: When the node belongs to the podCIDR size customization mode, the maximum number of pods running on the node can be
               specified.
        :param pulumi.Input[bool] enhanced_automation_service: Activate TencentCloud Automation Tools (TAT) service. If this parameter is not specified, the public image will default
        ...
        :param pulumi.Input[str] host_name: When reinstalling the system, you can specify the HostName of the instance to be modified (this parameter must be passed
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: The security group to which the instance belongs. This parameter can be obtained by calling the sgId field in the return
...
class ClusterMasterAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ClusterMasterAttachment resource with the given unique name, props, and options.
