...
class Ipv4AddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Ipv4AddressPrivateIpAddressArgs']]] private_ip_addresses: The information on private IP addresses, of which you can specify a maximum of 10 at a time. You should provide either
               this parameter or SecondaryPrivateIpAddressCount, or both.
        :param pulumi.Input[str] qos_level: IP service level. It is used together with `SecondaryPrivateIpAddressCount`. Values: PT`(Gold), `AU`(Silver), `AG
               `(Bronze) and DEFAULT (Default).
        :param pulumi.Input[int] secondary_private_ip_address_count: The number of newly-applied private IP addresses. You should provide either this parameter or PrivateIpAddresses, or
...
class Ipv4Address(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Ipv4Address resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] network_interface_id: The ID of the ENI instance, such as `eni-m6dyj72l`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ipv4AddressPrivateIpAddressArgs']]]] private_ip_addresses: The information on private IP addresses, of which you can specify a maximum of 10 at a time. You should provide either
               this parameter or SecondaryPrivateIpAddressCount, or both.
        :param pulumi.Input[str] qos_level: IP service level. It is used together with `SecondaryPrivateIpAddressCount`. Values: PT`(Gold), `AU`(Silver), `AG
               `(Bronze) and DEFAULT (Default).
        :param pulumi.Input[int] secondary_private_ip_address_count: The number of newly-applied private IP addresses. You should provide either this parameter or PrivateIpAddresses, or
