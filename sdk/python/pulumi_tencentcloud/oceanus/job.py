...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] cu_mem: Set the memory specification of each CU, in GB. It supports 2, 4, 8, and 16 (which needs to apply for the whitelist
        ...
        :param pulumi.Input[str] name: The name of the job. It can be composed of Chinese, English, numbers, hyphens (-), underscores (_), and periods (.), and
