...
class SyncConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dst_access_type: Target end access type, cdb (cloud database), cvm (cloud host self-built), vpc (private network), extranet (external
        ...
        :param pulumi.Input[str] src_access_type: Source access type, cdb (cloud database), cvm (cloud host self-built), vpc (private network), extranet (external
               network), vpncloud (vpn access), dcg (dedicated line access), ccn (cloud networking ), intranet (self-developed cloud),
               noProxy, note that the specific optional value depends on the current link.
        ...
        :param pulumi.Input[str] run_mode: Operation mode, such as: Immediate (indicates immediate operation, the default value is this value), Timed (indicates
               scheduled operation).
...
class SyncConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SyncConfig resource with the given unique name, props, and options.
