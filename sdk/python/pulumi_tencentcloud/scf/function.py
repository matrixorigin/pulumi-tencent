...
class FunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enable_public_net: Indicates whether public net config enabled. Default `false`. NOTE: only `vpc_id` specified can disable public net
               config.
        ...
        :param pulumi.Input[str] runtime: Runtime of the SCF function, only supports `Python2.7`, `Python3.6`, `Nodejs6.10`, `Nodejs8.9`, `Nodejs10.15`,
