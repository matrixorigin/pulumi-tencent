...
class AclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] validate_from: Access permission effective time, such as: 2021-09-22T00:00:00+08:00If the effective and expiry time are not filled in,
               the access rights will be valid for a long time.
        :param pulumi.Input[str] validate_to: Access permission expiration time, such as: 2021-09-23T00:00:00+08:00If the effective and expiry time are not filled in,
               the access rights will be valid for a long time.
        """
