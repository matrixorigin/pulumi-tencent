...
class PrivateNatGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ccn_id: Cloud Connect Network type The Cloud Connect Network instance ID required to be bound to the private network NAT
               gateway.
        ...
        :param pulumi.Input[str] vpc_id: Private Cloud instance ID. This parameter is required when creating a VPC type private network NAT gateway or a private
               network NAT gateway of private network gateway.
        :param pulumi.Input[bool] vpc_type: VPC type private network NAT gateway. Only when the value is True will a VPC type private network NAT gateway be
               created.
        """
...
class PrivateNatGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PrivateNatGateway resource with the given unique name, props, and options.
