...
class PullStreamTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] callback_events: defind the callback event you need, null for all. TaskStart, TaskExit, VodSourceFileStart, VodSourceFileFinish,
        ...
        :param pulumi.Input[str] vod_refresh_type: vod refresh method. `ImmediateNewSource`: switch to new source at once, `ContinueBreakPoint`: switch to new source while
               old source finish.
...
class PullStreamTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PullStreamTask resource with the given unique name, props, and options.
