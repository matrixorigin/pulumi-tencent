...
class StartStreamMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] audible_input_index_lists: The input index for monitoring the screen audio, supports multiple input audio sources.The valid range for InputIndex is
...
class StartStreamMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a StartStreamMonitor resource with the given unique name, props, and options.
