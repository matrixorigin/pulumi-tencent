...
class WatermarkRuleAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] template_id: The template Id can be acquired by the Id of `tencentcloud_css_watermark`.
        """
...
class WatermarkRuleAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WatermarkRuleAttachment resource with the given unique name, props, and options.
