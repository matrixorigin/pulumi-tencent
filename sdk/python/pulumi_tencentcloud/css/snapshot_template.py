...
class SnapshotTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cos_file_name: Cos file name. If it is empty, set according to the default value
...
class SnapshotTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SnapshotTemplate resource with the given unique name, props, and options.
