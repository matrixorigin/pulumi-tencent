...
class ActionTimerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ActionTimerActionTimerArgs'] action_timer: Scheduled tasks. This parameter can be used to specify scheduled tasks for instances, and currently only supports
...
class ActionTimer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ActionTimer resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['ActionTimerActionTimerArgs']] action_timer: Scheduled tasks. This parameter can be used to specify scheduled tasks for instances, and currently only supports
               scheduled destruction.
        :param pulumi.Input[str] instance_id: Instance ID.
        """
        ...
