...
class _OrgMemberEmailState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bind_status: Binding status is not binding: unbound, to be activated: value, successful binding: success, binding failure:
        ...
        :param pulumi.Input[int] member_uin: Member Uin.
        :param pulumi.Input[str] phone: Phone number.
        :param pulumi.Input[int] phone_bind: Safe mobile phone binding state is not bound: 0, has been binded: 1Note: This field may return NULL, indicating that the
    ...
    def bind_status(self) -> Optional[pulumi.Input[str]]:
        """
        Binding status is not binding: unbound, to be activated: value, successful binding: success, binding failure:
        failedNote: This field may return NULL, indicating that the valid value cannot be obtained.
        """
    ...
    def phone_bind(self) -> Optional[pulumi.Input[int]]:
        """
        Safe mobile phone binding state is not bound: 0, has been binded: 1Note: This field may return NULL, indicating that the
        valid value cannot be obtained.
        """
...
class OrgMemberEmail(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrgMemberEmail resource with the given unique name, props, and options.
