...
class OrgManagePolicyTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] target_type: Target type. Valid values: - `NODE`: Department. - `MEMBER`: Check Member.
        :param pulumi.Input[str] policy_type: Policy type. Default value is SERVICE_CONTROL_POLICY. Valid values: - `SERVICE_CONTROL_POLICY`: Service control policy.
...
class OrgManagePolicyTarget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrgManagePolicyTarget resource with the given unique name, props, and options.
