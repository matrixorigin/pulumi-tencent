...
class OrgManagePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Policy name. The length is 1~128 characters, which can include Chinese characters, English letters, numbers, and
               underscores.
        :param pulumi.Input[str] type: Policy type. Default value is SERVICE_CONTROL_POLICY. Valid values: - `SERVICE_CONTROL_POLICY`: Service control policy.
...
class OrgManagePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrgManagePolicy resource with the given unique name, props, and options.
