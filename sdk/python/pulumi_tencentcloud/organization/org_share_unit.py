...
class OrgShareUnitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Shared unit name. It only supports a combination of uppercase and lowercase letters, numbers, -, and _, with a length of
               3-128 characters.
        """
...
class OrgShareUnit(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrgShareUnit resource with the given unique name, props, and options.
