...
class DqRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] quality_dim: Rules belong to quality dimensions (1. accuracy, 2. uniqueness, 3. completeness, 4. consistency, 5. timeliness, 6.
               effectiveness).
...
class DqRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DqRule resource with the given unique name, props, and options.
