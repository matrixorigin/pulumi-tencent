...
class IntegrationOfflineTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] delay_time: Execution time, unit is minutes, only available for day/week/month/year scheduling. For example, daily scheduling is
        ...
        :param pulumi.Input[str] task_action: Scheduling configuration: flexible period configuration, only available for hourly/weekly/monthly/yearly scheduling. If
...
class IntegrationOfflineTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IntegrationOfflineTask resource with the given unique name, props, and options.
