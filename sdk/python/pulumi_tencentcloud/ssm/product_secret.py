...
class ProductSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] product_name: Name of the Tencent Cloud service bound to the credential, such as `Mysql`, `Tdsql-mysql`, `Tdsql_C_Mysql`. you can use
               dataSource `tencentcloud_ssm_products` to query supported products.
        :param pulumi.Input[str] secret_name: Credential name, which must be unique in the same region. It can contain 128 bytes of letters, digits, hyphens, and
               underscores and must begin with a letter or digit.
        :param pulumi.Input[str] user_name_prefix: Prefix of the user account name, which is specified by you and can contain up to 8 characters.Supported character sets
        ...
        :param pulumi.Input[bool] enable_rotation: Specifies whether to enable rotation, when secret status is `Disabled`, rotation will be disabled. `True` - enable,
               `False` - do not enable. If this parameter is not specified, `False` will be used by default.
        :param pulumi.Input[str] kms_key_id: Specifies the KMS CMK that encrypts the credential. If this parameter is left empty, the CMK created by Secrets Manager
               by default will be used for encryption.You can also specify a custom KMS CMK created in the same region for encryption.
        :param pulumi.Input[str] rotation_begin_time: User-Defined rotation start time in the format of 2006-01-02 15:04:05.When `EnableRotation` is `True`, this parameter is
               required.
...
class _ProductSecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] secret_name: Credential name, which must be unique in the same region. It can contain 128 bytes of letters, digits, hyphens, and
               underscores and must begin with a letter or digit.
        :param pulumi.Input[int] secret_type: `0`: user-defined secret. `1`: Tencent Cloud services secret. `2`: SSH key secret. `3`: Tencent Cloud API key secret.
...
class ProductSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ProductSecret resource with the given unique name, props, and options.
