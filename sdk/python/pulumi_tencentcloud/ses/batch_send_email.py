...
class BatchSendEmailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] from_email_address: Sender address. Enter a sender address such as noreply@mail.qcloud.com. To display the sender name, enter the address in
...
class BatchSendEmail(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BatchSendEmail resource with the given unique name, props, and options.
