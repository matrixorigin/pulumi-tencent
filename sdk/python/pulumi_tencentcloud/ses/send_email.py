...
class SendEmailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] destinations: Recipient email addresses. You can send an email to up to 50 recipients at a time. Note: the email content will display
               all recipient addresses. To send one-to-one emails to several recipients, please call the API multiple times to send the
               emails.
        :param pulumi.Input[str] from_email_address: Sender address. Enter a sender address, for example, noreply@mail.qcloud.com.To display the sender name, enter the
               address in the following format:Sender.
        :param pulumi.Input[str] subject: Email subject.
        :param pulumi.Input[Sequence[pulumi.Input['SendEmailAttachmentArgs']]] attachments: Parameters for the attachments to be sent. The TencentCloud API supports a request packet of up to 8 MB in size,and the
        ...
        :param pulumi.Input[str] reply_to_addresses: Reply-to address. You can enter a valid personal email address that can receive emails. If this parameter is left empty,
        ...
        :param pulumi.Input[int] trigger_type: Email triggering type. 0 (default): non-trigger-based, suitable for marketing emails and non-immediate emails;1:
        ...
        :param pulumi.Input[str] unsubscribe: Unsubscribe link option. 0: Do not add unsubscribe link; 1: English 2: Simplified Chinese; 3: Traditional Chinese; 4:
...
class SendEmail(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SendEmail resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SendEmailAttachmentArgs']]]] attachments: Parameters for the attachments to be sent. The TencentCloud API supports a request packet of up to 8 MB in size,and the
               size of the attachment content will increase by 1.5 times after Base64 encoding. Therefore,you need to keep the total
               size of all attachments below 4 MB. If the entire request exceeds 8 MB,the API will return an error.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] bccs: The email address of the cc recipient can support up to 20 cc recipients.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] ccs: Cc recipient email address, up to 20 people can be copied.
