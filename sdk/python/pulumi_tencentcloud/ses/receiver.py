...
class ReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReceiverDataArgs']]] datas: Recipient email and template parameters in array format. The number of recipients is limited to within 20,000. If there
...
class Receiver(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ReceiverDataArgs']]]] datas: Recipient email and template parameters in array format. The number of recipients is limited to within 20,000. If there
               is an object in the `data` list that inputs `template_data`, then other objects are also required.
        :param pulumi.Input[str] desc: Recipient group description.
        :param pulumi.Input[str] receivers_name: Recipient group name.
        """
