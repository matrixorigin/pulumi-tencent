...
class OrganizationMemberOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] permission_ids: List of member financial authority IDs. Values: 1-View bill, 2-View balance, 3-Fund transfer, 4-Consolidated
               disbursement, 5-Invoice, 6-Benefit inheritance, 7-Proxy payment, 1 and 2 must be default.
        ...
        :param pulumi.Input[str] name: Member name. The maximum length is 25 characters and supports English letters, numbers, Chinese characters, symbols `+`,
               `@`, `&`, `.`, `[`, `]`, `-`, `:`, `,` and enumeration comma.
    ...
    def permission_ids(self) -> pulumi.Input[Sequence[pulumi.Input[int]]]:
        """
        List of member financial authority IDs. Values: 1-View bill, 2-View balance, 3-Fund transfer, 4-Consolidated
        disbursement, 5-Invoice, 6-Benefit inheritance, 7-Proxy payment, 1 and 2 must be default.
        """
...
class OrganizationMemberOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OrganizationMemberOperation resource with the given unique name, props, and options.
