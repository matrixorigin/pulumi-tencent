...
class SiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] condition_requirement: Whether the following environmental conditions are met: n1. There are no material requirements or the acceptance
        ...
        :param pulumi.Input[bool] dimension_requirement: Whether the following dimension conditions are met: Your loading dock can accommodate one rack container (H x W x D = 94
        ...
        :param pulumi.Input[str] fiber_type: Site Fiber Type. Using optical fiber type to connect the CDC device to the network SM(Single-Mode) or MM(Multi-Mode)
        ...
        :param pulumi.Input[str] optical_standard: Site Optical Standard. Optical standard used to connect the CDC device to the network This field depends on the uplink
        ...
        :param pulumi.Input[bool] redundant_networking: Whether redundant upstream equipment (switch or router) is provided so that both network devices can be connected to the
               network.
