...
class DataEngineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] image_version_name: Cluster image version name. Such as SuperSQL-P 1.1; SuperSQL-S 3.2, etc., do not upload, and create a cluster with the
        ...
        :param pulumi.Input[int] time_span: Engine TimeSpan, prePay: minimum of 1, representing one month of purchasing resources, with a maximum of 120, default
               3600, postPay: fixed fee of 3600.
        :param pulumi.Input[str] time_unit: Engine TimeUnit, prePay: use m(default), postPay: use h.
        :param pulumi.Input[int] tolerable_queue_time: Tolerable queuing time, default 0. scaling may be triggered when tasks are queued for longer than the tolerable time. if
...
class DataEngine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DataEngine resource with the given unique name, props, and options.
