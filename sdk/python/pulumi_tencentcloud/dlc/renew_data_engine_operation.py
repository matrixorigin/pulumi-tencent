...
class RenewDataEngineOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] renew_flag: Automatic renewal flag, 0, initial state, automatic renewal is not performed by default. if the user has prepaid
...
class RenewDataEngineOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RenewDataEngineOperation resource with the given unique name, props, and options.
