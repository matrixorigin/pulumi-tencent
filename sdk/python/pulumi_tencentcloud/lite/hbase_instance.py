...
class HbaseInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] disk_size: Instance single-node disk capacity, in GB. The single-node disk capacity must be greater than or equal to 100 and less
        ...
        :param pulumi.Input[Sequence[pulumi.Input['HbaseInstanceZoneSettingArgs']]] zone_settings: Detailed configuration of the instance availability zone, currently supports multiple availability zones, the number of
...
class HbaseInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a HbaseInstance resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['HbaseInstanceZoneSettingArgs']]]] zone_settings: Detailed configuration of the instance availability zone, currently supports multiple availability zones, the number of
               availability zones can only be 1 or 3, including zone name, VPC information, and number of nodes. The total number of
               nodes across all zones must be greater than or equal to 3 and less than or equal to 50.
        """
        ...
