...
class InstanceBackupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] backup_method: Set automatic backup method. Valid values: - 0: Logical backup; - 1: Physical backup; - 3: Snapshot backup (supported
               only in cloud disk version).
        :param pulumi.Input[int] backup_time: Set the start time for automatic backup. The value range is: [0,23]. For example, setting this parameter to 2 means that
...
class InstanceBackupRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstanceBackupRule resource with the given unique name, props, and options.
