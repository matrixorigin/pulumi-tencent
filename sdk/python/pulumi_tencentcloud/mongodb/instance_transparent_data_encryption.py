...
class InstanceTransparentDataEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: Instance ID, for example: cmgo-p8vn ***. Currently supported general versions include: 4.4 and 5.0, but the cloud disk
...
class _InstanceTransparentDataEncryptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] kms_region: The region where the Key Management Service (KMS) serves, such as ap-shanghai.
        :param pulumi.Input[str] transparent_data_encryption_status: Represents whether transparent encryption is turned on. Valid values: - close: Not opened; - open: It has been opened.
        """
...
class InstanceTransparentDataEncryption(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstanceTransparentDataEncryption resource with the given unique name, props, and options.
