...
class IpAlarmThresholdConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] alarm_threshold: Alarm threshold, in Mbps, with a value of&gt;=0; When used as an input parameter, setting 0 will delete the alarm
...
class IpAlarmThresholdConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IpAlarmThresholdConfig resource with the given unique name, props, and options.
