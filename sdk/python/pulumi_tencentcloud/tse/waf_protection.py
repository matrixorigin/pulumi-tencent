...
class WafProtectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of protection resource. Reference value: `Global`: instance, `Service`: service, `Route`: route, `Object`:
...
class WafProtection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WafProtection resource with the given unique name, props, and options.
