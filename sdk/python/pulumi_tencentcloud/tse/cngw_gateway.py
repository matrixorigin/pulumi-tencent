...
class CngwGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] trade_type: trade type. Reference value: `0`: postpaid, `1`:Prepaid (Interface does not support the creation of prepaid instances
               yet).
        """
...
class CngwGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CngwGateway resource with the given unique name, props, and options.
