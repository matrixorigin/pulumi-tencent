...
class WatermarkTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] coordinate_origin: Origin position. Valid values: TopLeft: the origin of coordinates is in the top-left corner of the video, and the origin
        ...
        :param pulumi.Input[str] x_pos: The horizontal position of the origin of the watermark relative to the origin of coordinates of the video. % and px
        ...
        :param pulumi.Input[str] y_pos: The vertical position of the origin of the watermark relative to the origin of coordinates of the video. % and px
...
class WatermarkTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WatermarkTemplate resource with the given unique name, props, and options.
