...
class EventConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] delete_media_complete_event_switch: Whether to receive video deletion completion event notification, default `OFF` is to ignore the event notification, `ON`
               is to receive event notification.
        :param pulumi.Input[str] mode: How to receive event notifications. Valid values: - Push: HTTP callback notification; - PULL: Reliable notification
               based on message queuing.
        :param pulumi.Input[str] notification_url: The address used to receive 3.0 format callbacks when receiving HTTP callback notifications. Note: If you take the
               NotificationUrl parameter and the value is an empty string, the 3.0 format callback address is cleared.
        :param pulumi.Input[str] upload_media_complete_event_switch: Whether to receive video upload completion event notification, default `OFF` means to ignore the event notification,
...
class EventConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EventConfig resource with the given unique name, props, and options.
