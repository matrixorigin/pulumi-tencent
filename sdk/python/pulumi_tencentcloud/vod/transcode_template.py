...
class TranscodeTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] container: The container format. Valid values: `mp4`, `flv`, `hls`, `mp3`, `flac`, `ogg`, `m4a`, `wav` ( `mp3`, `flac`, `ogg`,
               `m4a`, and `wav` are audio file formats).
        ...
        :param pulumi.Input[str] segment_type: The segment type. This parameter is valid only if `Container` is `hls`. Valid values: `ts`: TS segment; `fmp4`: fMP4
               segment Default: `ts`.
    ...
    def container(self) -> pulumi.Input[str]:
        """
        The container format. Valid values: `mp4`, `flv`, `hls`, `mp3`, `flac`, `ogg`, `m4a`, `wav` ( `mp3`, `flac`, `ogg`,
        `m4a`, and `wav` are audio file formats).
        """
    ...
    def segment_type(self) -> Optional[pulumi.Input[str]]:
        """
        The segment type. This parameter is valid only if `Container` is `hls`. Valid values: `ts`: TS segment; `fmp4`: fMP4
        segment Default: `ts`.
        """
...
class TranscodeTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TranscodeTemplate resource with the given unique name, props, and options.
