...
class SampleSnapshotTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] sample_interval: Sampling interval. If `SampleType` is `Percent`, sampling will be performed at an interval of the specified percentage.
        ...
        :param pulumi.Input[str] fill_type: Fill type. Fill refers to the way of processing a screenshot when its aspect ratio is different from that of the source
        ...
        :param pulumi.Input[int] height: Maximum value of the height (or short side) of a screenshot in px. Value range: 0 and [128, 4,096]. If both `Width` and
        ...
        :param pulumi.Input[str] resolution_adaptive: Resolution adaption. Valid values: open: enabled. In this case, `Width` represents the long side of a video, while
...
class SampleSnapshotTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SampleSnapshotTemplate resource with the given unique name, props, and options.
