...
class ProfessionalClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cluster_name: Name of cluster. It does not support Chinese characters and special characters except dashes and underscores and cannot
               exceed 64 characters.
        :param pulumi.Input[str] product_name: Cluster specification code. Reference[Professional Cluster
               Specifications](https://cloud.tencent.com/document/product/1179/83705).
        :param pulumi.Input[int] storage_size: Storage specifications. Reference[Professional Cluster
               Specifications](https://cloud.tencent.com/document/product/1179/83705).
        :param pulumi.Input[Sequence[pulumi.Input[int]]] zone_ids: Multi-AZ deployment select three Availability Zones, like: [200002,200003,200004]. Single availability zone deployment
...
class ProfessionalCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ProfessionalCluster resource with the given unique name, props, and options.
