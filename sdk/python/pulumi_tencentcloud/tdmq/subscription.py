...
class SubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] auto_delete_policy_topic: Whether to automatically delete a dead letter topic and a retry letter topic. Setting is only allowed when
