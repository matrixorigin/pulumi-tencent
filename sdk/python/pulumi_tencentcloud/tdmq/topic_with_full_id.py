...
class TopicWithFullIdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] pulsar_topic_type: Pulsar Topic Type 0: Non-persistent non-partitioned 1: Non-persistent partitioned 2: Persistent non-partitioned 3:
...
class TopicWithFullId(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TopicWithFullId resource with the given unique name, props, and options.
