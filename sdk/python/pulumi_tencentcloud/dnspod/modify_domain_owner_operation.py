...
class ModifyDomainOwnerOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] domain_id: Domain ID. The parameter DomainId has a higher priority than the parameter Domain. If the parameter DomainId is passed,
...
class ModifyDomainOwnerOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ModifyDomainOwnerOperation resource with the given unique name, props, and options.
