...
class DomainLockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] lock_days: The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60
...
class DomainLock(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DomainLock resource with the given unique name, props, and options.
