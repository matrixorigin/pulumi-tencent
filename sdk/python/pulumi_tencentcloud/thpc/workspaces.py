...
class WorkspacesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_token: A string used to ensure the idempotence of the request. This string is generated by the customer and must be unique
               across different requests, with a maximum length of 64 ASCII characters. If this parameter is not specified, the
               idempotence of the request cannot be guaranteed. Example value: system-f3827db9-c58a-49cc-bf10-33fc1923a34a.
        ...
        :param pulumi.Input[str] host_name: The hostname of the instance. Windows instance: The name should be a combination of 2 to 15 characters comprised of
        ...
        :param pulumi.Input['WorkspacesPlacementArgs'] placement: The position of the instance. This parameter allows you to specify attributes such as the availability zone, project,
               and host machine (when creating a sub-instance on CDH) that the instance belongs to. Note: If you do not specify the
               LaunchTemplate parameter, Placement is a mandatory parameter. If both Placement and LaunchTemplate are passed, the
               values in Placement override the corresponding values in LaunchTemplate by default.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Workspace Security Group.
        :param pulumi.Input['WorkspacesSpaceChargePrepaidArgs'] space_charge_prepaid: Prepaid mode: This refers to the parameters related to the annual and monthly subscription. By this parameter, you can
               specify the purchase duration of the prepaid instances, whether to set auto-renewal, and other attributes. If the
               instance's billing mode is prepaid, this parameter is required.
    ...
    def client_token(self) -> Optional[pulumi.Input[str]]:
        """
        A string used to ensure the idempotence of the request. This string is generated by the customer and must be unique
        across different requests, with a maximum length of 64 ASCII characters. If this parameter is not specified, the
        idempotence of the request cannot be guaranteed. Example value: system-f3827db9-c58a-49cc-bf10-33fc1923a34a.
        """
    ...
    def placement(self) -> Optional[pulumi.Input['WorkspacesPlacementArgs']]:
        """
        The position of the instance. This parameter allows you to specify attributes such as the availability zone, project,
        and host machine (when creating a sub-instance on CDH) that the instance belongs to. Note: If you do not specify the
        LaunchTemplate parameter, Placement is a mandatory parameter. If both Placement and LaunchTemplate are passed, the
        values in Placement override the corresponding values in LaunchTemplate by default.
        """
    ...
    def space_charge_prepaid(self) -> Optional[pulumi.Input['WorkspacesSpaceChargePrepaidArgs']]:
        """
        Prepaid mode: This refers to the parameters related to the annual and monthly subscription. By this parameter, you can
        specify the purchase duration of the prepaid instances, whether to set auto-renewal, and other attributes. If the
        instance's billing mode is prepaid, this parameter is required.
        """
...
class Workspaces(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Workspaces resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[pulumi.InputType['WorkspacesPlacementArgs']] placement: The position of the instance. This parameter allows you to specify attributes such as the availability zone, project,
               and host machine (when creating a sub-instance on CDH) that the instance belongs to. Note: If you do not specify the
               LaunchTemplate parameter, Placement is a mandatory parameter. If both Placement and LaunchTemplate are passed, the
               values in Placement override the corresponding values in LaunchTemplate by default.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Workspace Security Group.
        :param pulumi.Input[pulumi.InputType['WorkspacesSpaceChargePrepaidArgs']] space_charge_prepaid: Prepaid mode: This refers to the parameters related to the annual and monthly subscription. By this parameter, you can
               specify the purchase duration of the prepaid instances, whether to set auto-renewal, and other attributes. If the
               instance's billing mode is prepaid, this parameter is required.
        :param pulumi.Input[str] space_charge_type: Workspace billing type.
        :param pulumi.Input[str] space_name: Workspace Display Name.
