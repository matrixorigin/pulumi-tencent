...
class UploadRevokeLetterOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] revoke_letter: The format of the base64-encoded certificate confirmation letter file should be jpg, jpeg, png, or pdf, and the size
...
class UploadRevokeLetterOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a UploadRevokeLetterOperation resource with the given unique name, props, and options.
