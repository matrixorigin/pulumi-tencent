...
class FreeCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dv_auth_method: Specify DV authorize method. Available values: `DNS_AUTO` - automatic DNS auth, `DNS` - manual DNS auth, `FILE` - auth
               by file.
...
class _FreeCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] status: Certificate status. 0 = Approving, 1 = Approved, 2 = Approve failed, 3 = expired, 4 = DNS record added, 5 = OV/EV
...
class FreeCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FreeCertificate resource with the given unique name, props, and options.
