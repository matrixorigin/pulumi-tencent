...
class DeployCertificateInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] status: Deployment cloud resource status: Live: -1: The domain name is not associated with a certificate.1: Domain name https is
...
class DeployCertificateInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DeployCertificateInstanceOperation resource with the given unique name, props, and options.
