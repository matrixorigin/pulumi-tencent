...
class UpdateCertificateInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] resource_types: The resource type that needs to be deployed. The parameter value is optional: clb, cdn, waf, live, ddos, teo,
        ...
        :param pulumi.Input[int] expiring_notification_switch: Whether to ignore expiration reminders for old certificates 0: Do not ignore notifications. 1: Ignore the notification
        ...
        :param pulumi.Input[bool] repeatable: Whether the same certificate is allowed to be uploaded repeatedly. If you choose to upload the certificate, you can
