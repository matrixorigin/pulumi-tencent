...
class ReplaceCertificateOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] valid_type: Verification type: DNS_AUTO = automatic DNS verification (this verification type is only supported for domain names that
        ...
        :param pulumi.Input[str] cert_csr_key_parameter: CSR encryption parameter, when CsrEncryptAlgo is RSA, you can choose 2048, 4096, etc., and the default is 2048; when
        ...
        :param pulumi.Input[str] csr_type: Type, default Original. Available options: Original = original certificate CSR, Upload = manual upload, Online = online
               generation.
...
class ReplaceCertificateOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ReplaceCertificateOperation resource with the given unique name, props, and options.
