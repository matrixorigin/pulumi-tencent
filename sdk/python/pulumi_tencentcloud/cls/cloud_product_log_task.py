...
class CloudProductLogTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cloud_product_region: Cloud product region. There are differences in the input format of different log types in different regions. Please
        ...
        :param pulumi.Input[str] log_type: Log type, Values: CDS-AUDIT, CDS-RISK, CDB-AUDIT, TDSQL-C-AUDIT, MongoDB-AUDIT, MongoDB-SlowLog, MongoDB-ErrorLog,
...
class CloudProductLogTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CloudProductLogTask resource with the given unique name, props, and options.
