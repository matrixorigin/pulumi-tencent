...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] backup_time: Instance backup time, in the format of 'HH:mm-HH:mm'. Time setting interval is four hours. Default to `02:00-06:00`. The
               ...
               `22:00-02:00`.
        :param pulumi.Input[int] binlog_period: Binlog retention time, in days. The minimum value is 7 days and the maximum value is 1830 days. This value cannot be set
               greater than the backup file retention time.
        :param pulumi.Input[int] binlog_standby_days: The standard starting number of days for log backup storage. The log backup will be converted when it reaches the
        ...
        :param pulumi.Input[int] retention_period: The retention time of backup files, in days. The minimum value is 7 days and the maximum value is 1830 days. And default
               value is `7`.
        """
