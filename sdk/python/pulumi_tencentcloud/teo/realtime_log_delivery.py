...
class RealtimeLogDeliveryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] area: Data delivery area, possible values are: `mainland`: within mainland China; `overseas`: worldwide (excluding mainland
               China).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] entity_lists: List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks.
        ...
        :param pulumi.Input[str] log_type: Data delivery type, the values are: `domain`: site acceleration log; `application`: four-layer proxy log;
        ...
        :param pulumi.Input[int] sample: The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio
               is 60.5%. Leaving it blank means the sampling ratio is 100%.
        :param pulumi.Input[str] task_name: The name of the real-time log delivery task. The format is a combination of numbers, English, -, and _. The maximum
               length is 200 characters.
        :param pulumi.Input[str] task_type: The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push
        ...
        :param pulumi.Input['RealtimeLogDeliveryCustomEndpointArgs'] custom_endpoint: Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to
               custom_endpoint.
        :param pulumi.Input[Sequence[pulumi.Input['RealtimeLogDeliveryCustomFieldArgs']]] custom_fields: The list of custom fields delivered supports extracting specified field values from HTTP request headers, response
        ...
        :param pulumi.Input[str] delivery_status: The status of the real-time log delivery task. The values are: `enabled`: enabled; `disabled`: disabled. Leave it blank
               to keep the original configuration. Not required when creating.
        :param pulumi.Input['RealtimeLogDeliveryLogFormatArgs'] log_format: The output format of log delivery. If it is not filled, it means the default format. The default format logic is as
...
class RealtimeLogDelivery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RealtimeLogDelivery resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[pulumi.InputType['RealtimeLogDeliveryCustomEndpointArgs']] custom_endpoint: Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to
               custom_endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RealtimeLogDeliveryCustomFieldArgs']]]] custom_fields: The list of custom fields delivered supports extracting specified field values from HTTP request headers, response
               headers, and cookies. Custom field names cannot be repeated and cannot exceed 200 fields.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] entity_lists: List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks.
               ...
               `https://cloud.tencent.com/document/api/1552/86336`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] fields: A list of preset fields for delivery.
        :param pulumi.Input[pulumi.InputType['RealtimeLogDeliveryLogFormatArgs']] log_format: The output format of log delivery. If it is not filled, it means the default format. The default format logic is as
               follows: when TaskType is `custom_endpoint`, the default format is an array of multiple JSON objects, each JSON object
               is a log; when TaskType is `s3`, the default format is JSON Lines; in particular, when TaskType is `cls`, the value of
               LogFormat.FormatType can only be json, and other parameters in LogFormat will be ignored. It is recommended not to pass
               LogFormat.
