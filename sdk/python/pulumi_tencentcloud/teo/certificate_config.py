...
class CertificateConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] mode: Mode of configuring the certificate, the values are: `disable`: Do not configure the certificate; `eofreecert`:
               Configure EdgeOne free certificate; `sslcert`: Configure SSL certificate. If not filled in, the default value is
               `disable`.
        :param pulumi.Input[Sequence[pulumi.Input['CertificateConfigServerCertInfoArgs']]] server_cert_infos: SSL certificate configuration, this parameter takes effect only when mode = sslcert, just enter the corresponding
...
class CertificateConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CertificateConfig resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] mode: Mode of configuring the certificate, the values are: `disable`: Do not configure the certificate; `eofreecert`:
               Configure EdgeOne free certificate; `sslcert`: Configure SSL certificate. If not filled in, the default value is
               `disable`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CertificateConfigServerCertInfoArgs']]]] server_cert_infos: SSL certificate configuration, this parameter takes effect only when mode = sslcert, just enter the corresponding
               CertId. You can go to the SSL certificate list to view the CertId.
        :param pulumi.Input[str] zone_id: Site ID.
        """
        ...
