...
class L4ProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] proxy_name: Layer 4 proxy instance name. You can enter 1-50 characters. Valid characters are a-z, 0-9, and hyphens (-). However,
        ...
        :param pulumi.Input[str] accelerate_mainland: Specifies whether to enable network optimization in the Chinese mainland. The default value off is used if left empty.
               ...
               `off`: Disable.
        :param pulumi.Input[str] area: Acceleration zone of the Layer 4 proxy instance. `mainland`: Availability zone in the Chinese mainland; `overseas`:
               Global availability zone (excluding the Chinese mainland); `global`: Global availability zone.
        :param pulumi.Input['L4ProxyDdosProtectionConfigArgs'] ddos_protection_config: Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For
               details, see [Exclusive DDoS Protection
               Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        :param pulumi.Input[str] ipv6: Specifies whether to enable IPv6 access. The default value off is used if left empty. This configuration can only be
               enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy
               Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable;
               `off`: Disable.
        :param pulumi.Input[str] static_ip: Specifies whether to enable the fixed IP address. The default value off is used if left empty. This configuration can
...
class L4Proxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a L4Proxy resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] area: Acceleration zone of the Layer 4 proxy instance. `mainland`: Availability zone in the Chinese mainland; `overseas`:
               Global availability zone (excluding the Chinese mainland); `global`: Global availability zone.
        :param pulumi.Input[pulumi.InputType['L4ProxyDdosProtectionConfigArgs']] ddos_protection_config: Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For
               details, see [Exclusive DDoS Protection
               Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        :param pulumi.Input[str] ipv6: Specifies whether to enable IPv6 access. The default value off is used if left empty. This configuration can only be
               enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy
