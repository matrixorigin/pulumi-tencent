...
class ApplicationProxyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] origin_values: Origin site information: When `OriginType` is `custom`, it indicates one or more origin sites, such as `['8.8.8.8',
        ...
        :param pulumi.Input[str] forward_client_ip: Passes the client IP. Default value is `OFF`. When Proto is TCP, valid values: `TOA`: Pass the client IP via TOA;
        ...
        :param pulumi.Input[str] status: Status, the values are: `online`: enabled; `offline`: deactivated; `progress`: being deployed; `stopping`: being
...
class ApplicationProxyRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApplicationProxyRule resource with the given unique name, props, and options.
