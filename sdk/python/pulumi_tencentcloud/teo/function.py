...
class FunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Function name. It can only contain lowercase letters, numbers, hyphens, must start and end with a letter or number, and
...
class _FunctionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] content: Function content, currently only supports JavaScript code, with a maximum size of 5MB.
        :param pulumi.Input[str] create_time: Creation time. The time is in Coordinated Universal Time (UTC) and follows the date and time format specified by the ISO
               8601 standard.
        ...
        :param pulumi.Input[str] name: Function name. It can only contain lowercase letters, numbers, hyphens, must start and end with a letter or number, and
               can have a maximum length of 30 characters.
        :param pulumi.Input[str] remark: Function description, maximum support of 60 characters.
        :param pulumi.Input[str] update_time: Modification time. The time is in Coordinated Universal Time (UTC) and follows the date and time format specified by the
               ISO 8601 standard.
        :param pulumi.Input[str] zone_id: ID of the site.
        """
