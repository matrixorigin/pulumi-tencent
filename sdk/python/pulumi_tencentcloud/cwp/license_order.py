...
class LicenseOrderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] license_type: LicenseType, 0 CWP Pro - Pay as you go, 1 CWP Pro - Monthly subscription, 2 CWP Ultimate - Monthly subscription. Default
               is 0.
        :param pulumi.Input[int] project_id: Project ID. Default is 0.
        :param pulumi.Input[int] region_id: Purchase order region, only 1 Guangzhou, 9 Singapore is supported here. Guangzhou is recommended. Singapore is
...
class LicenseOrder(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LicenseOrder resource with the given unique name, props, and options.
