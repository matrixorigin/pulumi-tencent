...
class Ipv6EniAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Ipv6EniAddressIpv6AddressArgs']]] ipv6_addresses: The specified `IPv6` address list, up to 10 can be specified at a time. Combined with the input parameter
...
class Ipv6EniAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Ipv6EniAddress resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ipv6EniAddressIpv6AddressArgs']]]] ipv6_addresses: The specified `IPv6` address list, up to 10 can be specified at a time. Combined with the input parameter
               `Ipv6AddressCount` to calculate the quota. Mandatory one with Ipv6AddressCount.
        :param pulumi.Input[str] network_interface_id: ENI instance `ID`, in the form of `eni-m6dyj72l`.
        :param pulumi.Input[str] vpc_id: VPC `ID`, in the form of `vpc-m6dyj72l`.
        """
    ...
    def _internal_init(__self__,
        ...
        super(Ipv6EniAddress, __self__).__init__(
            'tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress',
            resource_name,
            __props__,
            opts)
