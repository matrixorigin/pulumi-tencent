...
class LogDeliveryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] log_region: The region where the log set is located; if not specified, the region where the instance is located will be used by
               default.
        :param pulumi.Input[str] logset_id: The ID of the log set being delivered.
        :param pulumi.Input[str] logset_name: Log set name. If LogsetId does not specify a specific log set ID, please configure this parameter to set the log set
...
class LogDelivery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LogDelivery resource with the given unique name, props, and options.
