...
class ServiceLinkedRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] custom_suffix: The custom suffix, based on the string you provide, is combined with the prefix provided by the service to form the full
