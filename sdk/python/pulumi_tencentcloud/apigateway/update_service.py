...
class UpdateServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] environment_name: The name of the environment to be switched, currently supporting three environments: test (test environment), prepub
...
class UpdateService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a UpdateService resource with the given unique name, props, and options.
