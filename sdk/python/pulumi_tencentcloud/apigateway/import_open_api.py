...
class _ImportOpenApiState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] auth_relation_api_id: The unique ID of the associated authorization API takes effect when AuthType is OAUTH and ApiBusinessType is NORMAL. The
               unique ID of the oauth2.0 authorized API that identifies the business API binding.
        :param pulumi.Input[str] auth_type: API authentication type. Support SECRET (Key Pair Authentication), NONE (Authentication Exemption), OAUTH, APP
        ...
        :param pulumi.Input[bool] is_delete_response_error_codes: Do you want to delete the custom response configuration error code? If it is not passed or False is passed, it will not
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ImportOpenApiServiceConfigCosConfigArgs']]] service_config_cos_configs: API backend COS configuration. If ServiceType is COS, then this parameter must be passed.Note: This field may return
        ...
        :param pulumi.Input[str] service_config_scf_function_type: Scf function type. Effective when the backend type is SCF. Support Event Triggering (EVENT) and HTTP Direct Cloud
               Function (HTTP).
        ...
        :param pulumi.Input[str] service_config_upstream_id: Only required when binding to VPC channelsNote: This field may return null, indicating that a valid value cannot be
               obtained.
        ...
        :param pulumi.Input[str] service_config_websocket_cleanup_function_namespace: Scf websocket cleans up the function namespace. It takes effect when the current end type is WEBSOCKET and the backend
               type is SCF.
        :param pulumi.Input[str] service_config_websocket_cleanup_function_qualifier: Scf websocket cleaning function version. It takes effect when the current end type is WEBSOCKET and the backend type is
               SCF.
        ...
        :param pulumi.Input[str] service_config_websocket_register_function_namespace: Scf websocket registers function namespaces. It takes effect when the current end type is WEBSOCKET and the backend type
               is SCF.
        :param pulumi.Input[str] service_config_websocket_register_function_qualifier: Scf websocket transfer function version. It takes effect when the current end type is WEBSOCKET and the backend type is
               SCF.
        ...
        :param pulumi.Input[str] service_config_websocket_transport_function_namespace: Scf websocket transfer function namespace. It takes effect when the current end type is WEBSOCKET and the backend type
               is SCF.
        :param pulumi.Input[str] service_config_websocket_transport_function_qualifier: Scf websocket transfer function version. It takes effect when the current end type is WEBSOCKET and the backend type is
               SCF.
        :param pulumi.Input[str] service_id: The unique ID of the service where the API is located.
...
class ImportOpenApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ImportOpenApi resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] response_success_example: Successful response sample of custom response configuration.
        :param pulumi.Input[str] response_type: Return type. Valid values: `HTML`, `JSON`, `TEXT`, `BINARY`, `XML`. Default value: `HTML`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ImportOpenApiServiceConfigCosConfigArgs']]]] service_config_cos_configs: API backend COS configuration. If ServiceType is COS, then this parameter must be passed.Note: This field may return
               null, indicating that a valid value cannot be obtained.
        :param pulumi.Input[str] service_config_method: API backend service request method, such as `GET`. If `service_config_type` is `HTTP`, this parameter will be required.
               The frontend `request_config_method` and backend method `service_config_method` can be different.
        :param pulumi.Input[str] service_config_mock_return_message: Returned information of API backend mocking. This parameter is required when `service_config_type` is `MOCK`.
