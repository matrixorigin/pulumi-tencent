...
class ProcessMediaOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] output_dir: The directory to save the media processing output file, which must start and end with `/`, such as `/movie/201907/`.If
               you do not specify this parameter, the file will be saved to the directory specified in `InputInfo`.
        :param pulumi.Input['ProcessMediaOperationOutputStorageArgs'] output_storage: The storage location of the media processing output file. If this parameter is left empty, the storage location in
               `InputInfo` will be inherited.
        :param pulumi.Input[int] schedule_id: The scheme ID.Note 1: About `OutputStorage` and `OutputDir`If an output storage and directory are specified for a
        ...
        :param pulumi.Input[str] session_context: The source context which is used to pass through the user request information. The task flow status change callback will
               return the value of this field. It can contain up to 1,000 characters.
        :param pulumi.Input[str] session_id: The ID used for deduplication. If there was a request with the same ID in the last three days, the current request will
        ...
        :param pulumi.Input[str] task_type: The task type. `Online` (default): A task that is executed immediately. `Offline`: A task that is executed when the
               system is idle (within three days by default).
        :param pulumi.Input[int] tasks_priority: Task flow priority. The higher the value, the higher the priority. Value range: [-10, 10]. If this parameter is left
...
class ProcessMediaOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ProcessMediaOperation resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] output_dir: The directory to save the media processing output file, which must start and end with `/`, such as `/movie/201907/`.If
               you do not specify this parameter, the file will be saved to the directory specified in `InputInfo`.
        :param pulumi.Input[pulumi.InputType['ProcessMediaOperationOutputStorageArgs']] output_storage: The storage location of the media processing output file. If this parameter is left empty, the storage location in
               `InputInfo` will be inherited.
        :param pulumi.Input[int] schedule_id: The scheme ID.Note 1: About `OutputStorage` and `OutputDir`If an output storage and directory are specified for a
               subtask of the scheme, those output settings will be applied.If an output storage and directory are not specified for
               the subtasks of a scheme, the output parameters passed in the `ProcessMedia` API will be applied.Note 2: If
