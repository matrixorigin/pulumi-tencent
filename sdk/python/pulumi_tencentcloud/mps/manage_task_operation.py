...
class ManageTaskOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] operation_type: Operation type. Valid values:`Abort`: task termination. Notice: If the task type is live stream processing
...
class ManageTaskOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ManageTaskOperation resource with the given unique name, props, and options.
