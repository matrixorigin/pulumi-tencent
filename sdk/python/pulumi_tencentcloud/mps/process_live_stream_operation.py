...
class ProcessLiveStreamOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] output_dir: Target directory of a live stream processing output file, such as `/movie/201909/`. If this parameter is left empty, the
        ...
        :param pulumi.Input[str] session_id: The ID used for deduplication. If there was a request with the same ID in the last seven days, the current request will
...
class ProcessLiveStreamOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ProcessLiveStreamOperation resource with the given unique name, props, and options.
