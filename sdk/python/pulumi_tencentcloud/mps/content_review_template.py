...
class ContentReviewTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ContentReviewTemplateProhibitedConfigureArgs'] prohibited_configure: Prohibited control parameters. Prohibited content includes:abuse, drug-related violations.Note: this parameter is not
               yet supported.
...
class ContentReviewTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ContentReviewTemplate resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[pulumi.InputType['ContentReviewTemplateProhibitedConfigureArgs']] prohibited_configure: Prohibited control parameters. Prohibited content includes:abuse, drug-related violations.Note: this parameter is not
               yet supported.
