...
class EditMediaOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] tasks_priority: Task priority. The higher the value, the higher the priority. Value range: [-10,10]. If this parameter is left empty, 0
               will be used.
        """
...
class EditMediaOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EditMediaOperation resource with the given unique name, props, and options.
