...
class InputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InputInputGroupArgs'] input_group: The input group for the input. Only support one group for one `tencentcloud_mps_input`. Use `for_each` to create
...
class Input(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] flow_id: Flow ID.
        :param pulumi.Input[pulumi.InputType['InputInputGroupArgs']] input_group: The input group for the input. Only support one group for one `tencentcloud_mps_input`. Use `for_each` to create
               multiple inputs Scenario.
        """
        ...
    @overload
