...
class RiskCenterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] scan_asset_type: 0- Full scan, 1- Specify asset scan, 2- Exclude asset scan, 3- Manually fill in the scan. If 1 and 2 are required while
...
class RiskCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RiskCenter resource with the given unique name, props, and options.
