...
class CenterRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] deprovision_strategy: When you remove the last authorization configured with a certain privilege on a group account target account, whether to
...
class CenterRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterRoleAssignment resource with the given unique name, props, and options.
