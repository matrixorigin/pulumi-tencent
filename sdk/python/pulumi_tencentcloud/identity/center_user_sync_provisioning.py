...
class CenterUserSyncProvisioningArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] deletion_strategy: Deletion policy. It indicates the handling policy for CAM users already synchronized when the CAM user synchronization
        ...
        :param pulumi.Input[str] duplication_strategy: Conflict policy. It indicates the handling policy for existence of a user with the same username when CIC users are
        ...
        :param pulumi.Input[str] principal_id: Identity ID for the CAM user synchronization. Valid values: When the PrincipalType value is Group, it is the CIC user
               group ID (g-********). When the PrincipalType value is User, it is the CIC user ID (u-********).
        :param pulumi.Input[str] principal_type: Identity type for the CAM user synchronization. Valid values: User: indicates that the identity for the CAM user
               synchronization is a CIC user. Group: indicates that the identity for the CAM user synchronization is a CIC user group.
        :param pulumi.Input[str] target_type: Type of the synchronized target account of the Tencent Cloud Organization. ManagerUin: admin account; MemberUin: member
               account.
...
class _CenterUserSyncProvisioningState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] principal_id: Identity ID for the CAM user synchronization. Valid values: When the PrincipalType value is Group, it is the CIC user
               group ID (g-********). When the PrincipalType value is User, it is the CIC user ID (u-********).
        :param pulumi.Input[str] principal_name: The identity name of the CAM user synchronization. Value: When PrincipalType is Group, the value is the CIC user group
               name; When PrincipalType takes the value to User, the value is the CIC user name.
        :param pulumi.Input[str] principal_type: Identity type for the CAM user synchronization. Valid values: User: indicates that the identity for the CAM user
               synchronization is a CIC user. Group: indicates that the identity for the CAM user synchronization is a CIC user group.
        :param pulumi.Input[str] status: Status of CAM user synchronization. Value: * Enabled: CAM user synchronization is enabled; * Disabled: CAM user
...
class CenterUserSyncProvisioning(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterUserSyncProvisioning resource with the given unique name, props, and options.
