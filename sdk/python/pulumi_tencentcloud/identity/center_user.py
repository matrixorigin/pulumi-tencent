...
class CenterUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] user_name: User name. It must be unique in space. Modifications are not supported. Format: Contains numbers, English letters and
...
class CenterUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterUser resource with the given unique name, props, and options.
