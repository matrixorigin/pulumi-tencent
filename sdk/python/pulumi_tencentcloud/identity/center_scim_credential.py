...
class _CenterScimCredentialState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] credential_secret: SCIM key.
...
class CenterScimCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterScimCredential resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="credentialSecret")
    def credential_secret(self) -> pulumi.Output[str]:
        """
        SCIM key.
        """
        return pulumi.get(self, "credential_secret")
