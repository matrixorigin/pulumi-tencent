...
class CenterRoleConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] relay_state: Initial access page. It indicates the initial access page URL when CIC users use the access configuration to access the
        ...
        :param pulumi.Input[int] session_duration: Session duration. It indicates the maximum session duration when CIC users use the access configuration to access the
...
class CenterRoleConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterRoleConfiguration resource with the given unique name, props, and options.
