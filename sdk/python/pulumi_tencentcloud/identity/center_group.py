...
class CenterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] group_name: The name of the user group. Format: Allow English letters, numbers and special characters-. Length: Maximum 128
               characters.
...
class CenterGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CenterGroup resource with the given unique name, props, and options.
