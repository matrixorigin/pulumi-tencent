...
class Layer4ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] connect_timeout: Timeout of the health check response, should less than interval, default value is 2s. NOTES: Require less than
               `interval`.
        :param pulumi.Input[str] context_type: UDP source station health check port probe message type: TEXT represents text. Only used when the health check type is
               PORT.
        :param pulumi.Input[bool] health_check: Indicates whether health check is enable, default value is `false`.
        :param pulumi.Input[int] healthy_threshold: Health threshold, which indicates how many consecutive inspections are successful, the source station is determined to
        ...
        :param pulumi.Input[int] unhealthy_threshold: Unhealthy threshold, which indicates how many consecutive check failures the source station is considered unhealthy.
