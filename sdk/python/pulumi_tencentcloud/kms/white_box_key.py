...
class WhiteBoxKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] alias: As an alias for the key to be easier to identify and easier to understand, it cannot be empty and is a combination of
...
class WhiteBoxKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WhiteBoxKey resource with the given unique name, props, and options.
