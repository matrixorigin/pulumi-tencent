...
class ProtectionModeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] mode: Protection status:10: Rule observation; AI off mode, 11: Rule observation; AI observation mode, 12: Rule observation; AI
...
class ProtectionMode(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ProtectionMode resource with the given unique name, props, and options.
