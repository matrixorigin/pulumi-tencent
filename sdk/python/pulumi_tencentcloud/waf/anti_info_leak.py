...
class AntiInfoLeakArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] action_type: Rule Action. 0: alarm; 1: replacement; 2: only displaying the first four digits; 3: only displaying the last four
               digits; 4: blocking.
...
class AntiInfoLeak(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AntiInfoLeak resource with the given unique name, props, and options.
