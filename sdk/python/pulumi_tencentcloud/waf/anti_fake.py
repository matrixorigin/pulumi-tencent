...
class AntiFakeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] status: status. 0: Turn off rules and log switches, 1: Turn on the rule switch and Turn off the log switch; 2: Turn off the rule
...
class AntiFake(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AntiFake resource with the given unique name, props, and options.
