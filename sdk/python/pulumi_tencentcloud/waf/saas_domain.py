...
class SaasDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] cert_type: Certificate type, 0 represents no certificate, CertType=1 represents self owned certificate, and 2 represents managed
               certificate.
        ...
        :param pulumi.Input[str] https_upstream_port: Upstream port for https, When listen ports has https port and UpstreamScheme is HTTP, the current field needs to be
               filled.
        ...
        :param pulumi.Input[int] is_cdn: Whether a proxy has been enabled before WAF, 0 no deployment, 1 deployment and use first IP in X-Forwarded-For as client
        ...
        :param pulumi.Input[int] sni_type: Sni type fo upstream, 0:disable SNI; 1:enable SNI and SNI equal original request host; 2:and SNI equal upstream host
...
class SaasDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SaasDomain resource with the given unique name, props, and options.
