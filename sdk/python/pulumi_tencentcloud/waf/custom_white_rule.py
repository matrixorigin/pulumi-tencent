...
class CustomWhiteRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] expire_time: Expiration time, measured in seconds, such as 1677254399, which means the expiration time is 2023-02-24 23:59:59 0 means
               never expires.
...
class CustomWhiteRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CustomWhiteRule resource with the given unique name, props, and options.
