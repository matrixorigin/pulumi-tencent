...
class SaasInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] real_region: region. If Region is `ap-guangzhou`, support: gz, sh, bj, cd (Means: GuangZhou, ShangHai, BeiJing, ChengDu); If Region
...
class SaasInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SaasInstance resource with the given unique name, props, and options.
