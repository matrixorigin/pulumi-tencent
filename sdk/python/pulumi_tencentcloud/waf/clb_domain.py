...
class ClbDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] engine: Protection Status: 10: Rule Observation&&AI Off Mode, 11: Rule Observation&&AI Observation Mode, 12: Rule
...
class ClbDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ClbDomain resource with the given unique name, props, and options.
