...
class IpAccessControlV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] domain: Specific domain name, for example, test.qcloudwaf.com. Global domain name, that is, global.
...
class IpAccessControlV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IpAccessControlV2 resource with the given unique name, props, and options.
