...
class LogstashArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] node_type: Node type. Valid values: - LOGSTASH.S1.SMALL2: 1 core 2G; - LOGSTASH.S1.MEDIUM4:2 core 4G; - LOGSTASH.S1.MEDIUM8:2 core
        ...
        :param pulumi.Input[str] renew_flag: Automatic renewal flag. RENEW_FLAG_AUTO: auto renewal; RENEW_FLAG_MANUAL: do not renew automatically, users renew
...
class Logstash(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Logstash resource with the given unique name, props, and options.
