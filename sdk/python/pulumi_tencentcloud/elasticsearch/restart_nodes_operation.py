...
class RestartNodesOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] restart_mode: Optional restart mode in-place,blue-green, which means restart and blue-green restart, respectively. The default is
               in-place.
        """
...
class RestartNodesOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RestartNodesOperation resource with the given unique name, props, and options.
