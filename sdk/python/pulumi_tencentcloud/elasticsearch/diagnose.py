...
class DiagnoseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cron_time: Intelligent operation and maintenance staff regularly patrol the inspection time every day, the time format is HH:00:00,
               such as 15:00:00.
        """
...
class Diagnose(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Diagnose resource with the given unique name, props, and options.
