...
class ImageRegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] insecure: Valid values: `0` (secure mode with certificate verification, which is the default value); `1` (unsecure mode that skips
...
class ImageRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ImageRegistry resource with the given unique name, props, and options.
