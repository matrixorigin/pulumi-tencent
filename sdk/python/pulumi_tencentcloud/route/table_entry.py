...
class TableEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] next_type: Type of next-hop. Valid values: `CVM`, `VPN`, `DIRECTCONNECT`, `PEERCONNECTION`, `HAVIP`, `NAT`, `NORMAL_CVM`, `EIP` and
               `LOCAL_GATEWAY`.
...
class TableEntry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TableEntry resource with the given unique name, props, and options.
