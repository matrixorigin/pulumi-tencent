...
class EdgeFirewallSwitchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] subnet_id: The first EIP switch in the vpc is turned on, and you need to specify a subnet to create a private connection. If
...
class EdgeFirewallSwitch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EdgeFirewallSwitch resource with the given unique name, props, and options.
