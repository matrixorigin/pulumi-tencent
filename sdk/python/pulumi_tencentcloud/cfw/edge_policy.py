...
class EdgePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] protocol: Protocol. If Direction=1 && Scope=serial, optional values: TCP UDP ICMP ANY HTTP HTTPS HTTP/HTTPS SMTP SMTPS SMTP/SMTPS
               FTP DNS; If Direction=1 && Scope!=serial, optional values: TCP; If Direction=0 && Scope=serial, optional values: TCP UDP
               ICMP ANY HTTP HTTPS HTTP/HTTPS SMTP SMTPS SMTP/SMTPS FTP DNS; If Direction=0 && Scope!=serial, optional values: TCP
               HTTP/HTTPS TLS/SSL.
        :param pulumi.Input[str] rule_action: How the traffic set in the access control policy passes through the cloud firewall. Values: accept: allow; drop: reject;
               log: observe.
        :param pulumi.Input[str] source_content: Access source example: net:IP/CIDR(192.168.0.2).
        :param pulumi.Input[str] source_type: Access source type: for inbound rules, the type can be net, location, vendor, template; for outbound rules, it can be
               net, instance, tag, template, group.
        ...
        :param pulumi.Input[str] target_type: Access purpose type: For inbound rules, the type can be net, instance, tag, template, group; for outbound rules, it can
               be net, location, vendor, template.
    ...
    def protocol(self) -> pulumi.Input[str]:
        """
        Protocol. If Direction=1 && Scope=serial, optional values: TCP UDP ICMP ANY HTTP HTTPS HTTP/HTTPS SMTP SMTPS SMTP/SMTPS
        FTP DNS; If Direction=1 && Scope!=serial, optional values: TCP; If Direction=0 && Scope=serial, optional values: TCP UDP
        ICMP ANY HTTP HTTPS HTTP/HTTPS SMTP SMTPS SMTP/SMTPS FTP DNS; If Direction=0 && Scope!=serial, optional values: TCP
        HTTP/HTTPS TLS/SSL.
        """
    ...
    def rule_action(self) -> pulumi.Input[str]:
        """
        How the traffic set in the access control policy passes through the cloud firewall. Values: accept: allow; drop: reject;
        log: observe.
        """
    ...
    def source_type(self) -> pulumi.Input[str]:
        """
        Access source type: for inbound rules, the type can be net, location, vendor, template; for outbound rules, it can be
        net, instance, tag, template, group.
        """
    ...
    def target_type(self) -> pulumi.Input[str]:
        """
        Access purpose type: For inbound rules, the type can be net, instance, tag, template, group; for outbound rules, it can
        be net, location, vendor, template.
        """
...
class EdgePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EdgePolicy resource with the given unique name, props, and options.
