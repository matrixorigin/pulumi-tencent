...
class VpcPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] rule_action: How traffic set in the access control policy passes through the cloud firewall. Value: accept:accept, drop:drop,
               log:log.
    ...
    def rule_action(self) -> pulumi.Input[str]:
        """
        How traffic set in the access control policy passes through the cloud firewall. Value: accept:accept, drop:drop,
        log:log.
        """
...
class VpcPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a VpcPolicy resource with the given unique name, props, and options.
