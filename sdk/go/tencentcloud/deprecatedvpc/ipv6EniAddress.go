...
func NewIpv6EniAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv6EniAddress(ctx *pulumi.Context,
	...
	var resource Ipv6EniAddress
	err := ctx.ReadResource("tencentcloud:Deprecatedvpc/ipv6EniAddress:Ipv6EniAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
